...
describe('Testing coffee modell', function() {
  ...
  describe('Testing title', function() {
    it('Should return "Kaffe" when adding "Kaffe"', function() {
        var coffee = new Coffee('Kaffe', 'Gott kaffe!',
            '2016-11-27T14:01:54Z', '2016-12-29T14:01:54Z',
            'www.djakne.se/image','www.djaken.se');
    ...
    it('should return "undefined" when adding 45', function() {
          var coffee = new Coffee(45, 'Gott kaffe!', '2016-11-27T14:01:54Z',
          '2016-12-29T14:01:54Z', 'www.djakne.se/image',
          'www.djaken.se');
          expect(coffee.title).to.equal(undefined);
        });
  });
  ...
  describe('Testing startDate', function() {
        it('Should return "2016-11-27T14:01:54Z" adding "2016-11-27T14:01:54Z"',
          function() {
            var coffee = new Coffee('Kaffe', 'Gott kaffe!',
              '2016-11-27T14:01:54Z', '2016-12-29T14:01:54Z',
              'www.djakne.se/image', 'www.djaken.se');
            expect(coffee.startDate).to.equal('2016-11-27T14:01:54Z');
          });
        it('Should return "undefined" when adding 20',
          function() {
            var coffee = new Coffee('Kaffe', 'Gott kaffe!',
              20, '2016-12-29T14:01:54Z', 'www.djakne.se/image',
              'www.djaken.se');
        ...
        it('Should return "undefined" when adding "undefined"',
          function() {
            var coffee = new Coffee('Kaffe', 'Gott kaffe!',
              undefined, '2016-12-29T14:01:54Z', 'www.djakne.se/image',
              'www.djaken.se');
            expect(coffee.startDate).to.equal(undefined);
          });
        it('Should return "undefined" when adding "hej"',
          function() {
            var coffee = new Coffee('Kaffe', 'Gott kaffe!',
              'hej', '2016-12-29T14:01:54Z', 'www.djakne.se/image',
              'www.djaken.se');
            expect(coffee.startDate).to.equal(undefined);
          });
      });
  ...
  it('Should return "2016-12-29T14:01:54Z" when adding "2016-12-29T14:01:54Z"',
        function() {
          var coffee = new Coffee('Kaffe', 'Gott kaffe!',
              '2016-11-27T14:01:54Z', '2016-12-29T14:01:54Z',
              'www.djakne.se/image','www.djaken.se');
          expect(coffee.endDate).to.equal('2016-12-29T14:01:54Z');
        });
  it('Should return "undefined" when adding 20', function() {
      var coffee = new Coffee('Kaffe', 'Gott kaffe!',
            '2016-11-27T14:01:54Z', '20', 'www.djakne.se/image',
            'www.djaken.se');
      expect(coffee.endDate).to.equal(undefined);
    });
  it('Should return "undefined" when adding "undefined"', function() {
          var coffee = new Coffee('Kaffe', 'Gott kaffe!',
            '2016-11-27T14:01:54Z', undefined, 'www.djakne.se/image',
            'www.djaken.se');
          expect(coffee.endDate).to.equal(undefined);
        });
  it('Should return "undefined" when adding "hej"', function() {
    var coffee = new Coffee('Kaffe', 'Gott kaffe!',
            '2016-11-27T14:01:54Z', 'hej', 'www.djakne.se/image',
            'www.djaken.se', '1,2,3');
    expect(coffee.endDate).to.equal(undefined);
  });
});
  ...
  describe('Testing image url', function() {
    ...
    it('Should return "undefined" when adding undefined', function() {
          var coffee = new Coffee('Kaffe', 'Gott kaffe!',
            '2016-11-27T14:01:54Z', '2016-12-29T14:01:54Z', undefined,
            'www.djaken.se');
          expect(coffee.image).to.equal(undefined);
        });
    it('Should return "undefined" when adding hej', function() {
          var coffee = new Coffee('Kaffe', 'Gott kaffe!',
            '2016-11-27T14:01:54Z', '2016-12-29T14:01:54Z', 'hej',
            'www.djaken.se');
          expect(coffee.image).to.equal(undefined);
        });
    it('Should return "undefined" when adding 45', function() {
      var coffee = new Coffee('Kaffe', 'Gott kaffe!',
            '2016-11-27T14:01:54Z', '2016-12-29T14:01:54Z', 45,
            'www.djaken.se');
      expect(coffee.image).to.equal(undefined);
    });
  });
